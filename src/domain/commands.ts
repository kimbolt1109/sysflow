...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "status", description: "Provider quota and usage status.", status: "ready" },
  { name: "usage", description: "Plan usage limits and rate limits.", status: "ready" },
  { name: "cost", description: "Session and daily cost.", status: "ready" },
  { name: "sessions", description: "List sessions with previews.", status: "ready" },
  { name: "fork", description: "Branch the session into a copy.", status: "ready" },
  { name: "new", description: "Start a fresh session.", status: "ready" },
  { name: "rename", description: "Rename the current session.", status: "ready" },
  { name: "copy", description: "Copy a response to a file (or show it).", status: "ready" },
  { name: "tasks", description: "Show session activity.", status: "ready" },
  { name: "reload", description: "Rescan skills, subagents, and commands.", status: "ready" },
  ...
  { name: "undo", description: "Undo the last file change.", status: "ready" },
  { name: "rewind", description: "Rewind to an earlier checkpoint.", status: "ready" },
  { name: "export", description: "Export the conversation to a file.", status: "ready" },
  { name: "theme", description: "Switch theme presets.", status: "ready" },
